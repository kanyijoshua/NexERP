...
public class ABPmicroserviceDbMigrationService(
...
) : ITransientDependency
{
    ...
    private readonly ILogger<ABPmicroserviceDbMigrationService> _logger = logger;
    ...
    private async Task CreateDatabasesAsync(CancellationToken cancellationToken)
    {
        ...
        await EnsureDatabaseAsync<ErpDbContext>(cancellationToken);
