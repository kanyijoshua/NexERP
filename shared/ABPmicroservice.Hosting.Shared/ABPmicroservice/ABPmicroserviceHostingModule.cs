...
public class ABPmicroserviceHostingModule : AbpModule
{
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            var cstr = configuration.GetConnectionString(ABPmicroserviceNames.RabbitMq);
    ...
    )
    {
        context.Services.AddSingleton<IDistributedLockProvider>(sp =>
        {
            var connection = ConnectionMultiplexer.Connect(
                configuration.GetConnectionString(ABPmicroserviceNames.Redis)!
            );
...
public static class HostingExtensions
{
    ...
    )
    {
        var dataProtectionBuilder = context
            ...
            .SetApplicationName(ABPmicroserviceNames.ABPmicroservice);
