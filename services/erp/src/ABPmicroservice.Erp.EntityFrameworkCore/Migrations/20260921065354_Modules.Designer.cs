...
namespace ABPmicroservice.Erp.Migrations
{
    ...
    [Migration("20260921065354_Modules")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ABPmicroservice.Erp.Modules.ErpModuleState", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TenantId", "CompanyId", "ModuleCode")
                        .IsUnique()
                        .HasFilter("\"IsDeleted\" = false");

                    NpgsqlIndexBuilderExtensions.AreNullsDistinct(b.HasIndex("TenantId", "CompanyId", "ModuleCode"), false);

                    b.ToTable("ErpModuleStates", (string)null);
                });
            ...
            modelBuilder.Entity("ABPmicroservice.Erp.Reporting.CustomReportLayout", b =>
                {
                    ...
                    b.HasIndex("CompanyId", "ReportName");
            ...
            modelBuilder.Entity("ABPmicroservice.Erp.Reporting.ReportLayoutSelection", b =>
                {
                    ...
                    b.HasIndex("TenantId", "CompanyId", "ReportName")
                        .IsUnique()
                        .HasFilter("\"IsDeleted\" = false");

                    NpgsqlIndexBuilderExtensions.AreNullsDistinct(b.HasIndex("TenantId", "CompanyId", "ReportName"), false);
