...
using ABPmicroservice.WebApp.Blazor.Client.Menus;
...
[DependsOn(typeof(ABPmicroserviceWebAppDomainSharedModule))]
...
public class WebAppBlazorClientModule : AbpModule
{
    ...
    private static void ConfigureAuthentication(WebAssemblyHostBuilder builder)
    {
        builder.Services.AddOidcAuthentication(options =>
        {
            ...
            options.ProviderOptions.DefaultScopes.Add(ABPmicroserviceNames.AdministrationApi);
